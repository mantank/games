    ...
    */
    {
        ...
        description: "Manage a busy supermarket checkout in this fast-paced cashier simulation! Scan items, collect payments, and keep customers happy as you deal with increasingly challenging scenarios. With time management mechanics and various customer types, this retail simulator tests your multitasking skills in a hectic shopping environment. #games #simulation #timemanagement",
        thumbnail: "games/checkout-frenzy-cashier-game-lg.jpg",
        category: ["casual", "puzzle"],
        theme: ["minimalist", "simulation"],
        gameUrl: "https://cloud.onlinegames.io/games/2025/unity/checkout-frenzy/index-og.html",
        isFeatured: true,
        isNew: true,
        popularity: 94,
    ...
    {
        id: "sprunked-online",
        title: "Sprunked Online",
        description: "Jump and dodge obstacles in this addictive platformer adventure! Navigate through challenging levels filled with spikes, moving platforms, and unexpected traps. With tight controls and progressively difficult stages, this colorful platforming experience will test your timing and reflexes as you aim for the fastest completion times. #games #platformer #arcade",
        thumbnail: "games/sprunked-online-lg.jpg",
        category: ["action", "casual"],
        theme: ["adventure", "cartoon"],
        gameUrl: "https://cloud.onlinegames.io/games/2024/more2/sprunked/index.html",
        isFeatured: true,
        isNew: true,
        popularity: 92,
        dateAdded: "2024-03-27",
    ...
    },
    {
        ...
        description: "Build and expand your mining operation in this strategic idle game! Start with a simple mine and grow into a massive mining empire through automation, upgrades, and resource management. With an engaging progression system and multiple development paths, this resource tycoon game offers satisfying expansion mechanics and strategic depth. #games #idle #strategy",
        thumbnail: "games/idle-mining-empire-512-lg.jpg",
        category: ["casual", "puzzle"],
        theme: ["simulation", "minimalist"],
        gameUrl: "https://unblocked-games.s3.amazonaws.com/games/2023/mjs/idle-mining-empire/index.html",
        isFeatured: false,
        isNew: true,
        popularity: 90,
        dateAdded: "2024-03-27",
    ...
    },
    {
        ...
        description: "Race through beach-themed obstacle courses in this thrilling motocross game! Control your motorcycle through challenging water park levels, performing stunts and avoiding hazards to achieve the fastest time. With physics-based gameplay, trick mechanics, and summer-themed environments, this adrenaline-pumping racing experience offers exciting challenges for speed enthusiasts. #games #racing #stunts",
        thumbnail: "games/Moto-X3M-Pool-Party-512x512-lg.jpg",
        category: ["racing", "action"],
        theme: ["adventure", "sports"],
        gameUrl: "https://unblocked-games.s3.amazonaws.com/games/2024/gm/moto-x3m-pool-party/index.html",
        isFeatured: true,
        isNew: true,
        popularity: 95,
        dateAdded: "2024-03-27",
